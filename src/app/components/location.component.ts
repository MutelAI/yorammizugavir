            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 flex flex-col justify-center gap-6">
              ...
              <div class="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a [href]="'tel:' + b.phone" class="text-emerald-600 hover:underline">{{ b.phone_display }}</a>
                </div>
              </div>


              <a [href]="b.maps_url" target="_blank" rel="noopener"
                 class="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-6 rounded-xl transition-colors mt-2">
